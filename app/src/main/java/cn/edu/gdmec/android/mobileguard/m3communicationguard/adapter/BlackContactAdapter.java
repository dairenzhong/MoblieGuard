...
public class BlackContactAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.mljTV = (TextView) view.findViewById(R.id.tv_black_type);
        ...
        holder.mljTV.setText(contactInfos.get(i).lanjie);
        ...
        holder.mljTV.setTextColor(context.getResources().getColor(R.color.bright_purple));
